...
String str = "GET https://api.thingspeak.com/update?api_key=U1R7O7PRHKAZNS6M";
...
void tcpInit()
{
  ...
  sendAT("AT+CIPSTART=\"TCP\",\"api.thingspeak.com\",\"80\"\r\n",5000);
  sendAT("AT+CIPSEND\r\n",2000);
  String str="GET https://api.thingspeak.com/update?api_key=U1R7O7PRHKAZNS6M&field1="+ String(temperature);
