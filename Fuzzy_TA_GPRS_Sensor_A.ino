...
String str = "GET https://api.thingspeak.com/update?api_key=CGP0H7TPAOO2M9L1"; //API Write key Thingspeak
...
void tcpInit()
{
  ...
  sendAT("AT+CIPSTART=\"TCP\",\"api.thingspeak.com\",\"80\"\r\n",5000);
  sendAT("AT+CIPSEND\r\n",2000);
  String str="GET https://api.thingspeak.com/update?api_key=CGP0H7TPAOO2M9L1&field1="+ String(temperature);
